...
export const REQ_TYPES: RequestType[] = [
  ...
  {
    id: 'retrieve-nextlink',
    name: 'Retrieve NextLink',
    method: 'GET',
    group: 'read',
  ...
  },
  {
    ...
    name: 'Manage Attachment / Note',
    method: 'POST',
    group: 'binary',
    icon: Attach20Regular,
    sub: 'Attachment & Annotation',
    implemented: true,
    executeVerb: 'Run',
  },
];
