          ...
          >
            <div
              style={{
                ...
                padding: '4px 10px',
                borderRadius: 999,
                backgroundColor: groupColorVar(type.group),
                color: '#fff',
                fontSize: 11,
                fontWeight: 700,
            ...
            <MessageBar layout="multiline" intent="info">
              <MessageBarBody>
                This mode isn't available yet. Pick another mode from the request type switcher
                above.
              </MessageBarBody>
            </MessageBar>
            ...
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              <Button appearance="primary" onClick={() => onPick('retrieve-multiple')}>
                Retrieve Multiple
              </Button>
              <Button appearance="outline" onClick={() => onPick('retrieve-single')}>
                Retrieve Single
              </Button>
              <Button appearance="outline" onClick={() => onPick('retrieve-nextlink')}>
                Retrieve NextLink
              </Button>
              <Button appearance="outline" onClick={() => onPick('predefined-query')}>
                Predefined Query
              </Button>
            </div>
          </Card>
