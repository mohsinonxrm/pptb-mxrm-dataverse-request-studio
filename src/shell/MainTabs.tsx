...
import { TextBulletList20Regular, Code20Regular, Table20Regular } from '@fluentui/react-icons';
    ...
    <main className={s.main}>
      <div className={s.mainTabsBar}>
        <TabList selectedValue={tab} onTabSelect={(_, d) => onTabChange(d.value as MainTab)}>
          <Tab value="builder" icon={<TextBulletList20Regular />}>
            Builder
          </Tab>
          ...
          <Tab value="results" icon={<Table20Regular />}>
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
              Results
              {resultCount != null && (
                <Badge size="extra-small" appearance="tint">
                  {resultCount}
                </Badge>
              )}
            </span>
